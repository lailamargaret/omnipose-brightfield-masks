...
class App:
    ...
    def export_file_list(self, key, groups, output_dir):
        ...
        image_list = groups[key] 
        with open(outpath, "w") as f:
            for channel, rel_path in image_list:
                cleaned_path = rel_path.replace("\\", "/")
    ...
    def call_cellprofiler_rainbow_pipeline(self, directory):
        ...
        file_list = self.export_file_list(wellpos, groups, filelist_dir)
        return
